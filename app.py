...
BASE_SYSTEM_PROMPT = (
    ...
    "If the retrieved documents do not contain a definitive answer, respond "
    "exactly: 'I cannot find this information in the official documents; "
    f"please contact the Township Clerk at {CLERK_PHONE}.' "
